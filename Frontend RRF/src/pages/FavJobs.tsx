  ...
  const jobs: Job[] = [
    {
      ...
      imageUrl:
        '/assets/company/360_F_482385584_Dv6qBsdFeUvVZoZSzCCUm09pZv4cnkw4.png',
    },
    {
      companyName: 'Google',
    ...
    },
    {
      ...
      imageUrl:
        '/assets/company/infosys-leases-5-lakh-square-feet-in-bengaluru.png',
    },
  ];
    ...
    <div>
      <section className="favorite-jobs-section1">
        ...
        <h3 className="section-subtitle">
          Right Resource Fit: Find Your Dream Job
        </h3>
