...
const testimonialData: TestimonialItem[] = [
  ...
  },
  {
    ...
    avatarUrl:
      '/assets/uxer avtar/compressed_fc7d2208a932c3899f0093cb7eee32c7.png',
    rating: 5,
  },
];
  ...
  return (
    <div>
      <div className="testimonial-section">
        ...
        <h4>
          Curious about the reviews from users who have used the Right Resource
          Fit website to find their next career opportunity? Let’s check below!
        </h4>
